...
/**
 * Defines finite group on top of the finite integer number set.
 */
public abstract class BaseNumericGroup implements FiniteGroup<Integer> {
  private final int from;
  private final int to;

  public BaseNumericGroup(int from, int to) {
    if (from >= to) {
