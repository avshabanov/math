package com.alexshabanov.nn.ch1;

import com.alexshabanov.nn.ch1.ofn.SimpleNeuralNetwork;
import com.alexshabanov.nn.ch1.ofn.TrainingData;
 ...
 * Main entry point.
 */
public final class ClassifyMain {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final SimpleNeuralNetwork neuralNetwork = new SimpleNeuralNetwork(ThreadLocalRandom.current(),
        new int[] {784, 100, 10});
    neuralNetwork.stochasticGradientDescent(trainingDataSet, 30, 10, 3.0, true);
    ...
    for (int i = 0; i < Math.min(10, trainingDataSet.size()); ++i) {
      ...
      final double[] output = neuralNetwork.evaluate(td.getInput());
      System.out.println("Image #" + i + ", expected label: " + images.labels[i]);
      System.out.println("\tGot output=" + doublesToString(output) + ", expected=" + doublesToString(td.getOutput()));
    }
  ...
  public static String doublesToString(double[] arr) {
